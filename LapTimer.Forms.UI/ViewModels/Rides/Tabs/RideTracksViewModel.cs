namespace LapTimer.Forms.UI.ViewModels.Rides
{
    ...
    public class RideTracksViewModel : MvxNavigationViewModel
    {
        ...
        private Task<ActivityHeaderModel> CreateHeaderViewModelAsync(RideModel ride)
        {
            return Task.Run(
                 () =>
                 {
        ...
        private Task<ActivityHeaderModel> CreateHeaderViewModelAsync(Activity activity)
        {
            return Task.Run(
                () =>
                {
        ...
        private async Task<List<ActivityHeaderModel>> LoadAsync()
        {
        ...
        private readonly IDbActivityService _dbactivityService;
        private readonly ITcxActivityService _tcxActivityService;

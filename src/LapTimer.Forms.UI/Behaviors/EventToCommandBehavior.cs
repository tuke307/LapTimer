namespace LapTimer.Forms.UI.Behaviors
{
    ...
    /// <summary>
    /// Behavior class that enable using <see cref="ICommand" /> to react on events raised
    /// by <see cref="BindableObject" /> bindable.
    /// </summary>
    /// <para>
    /// There are multiple ways to pass a parameter to the <see cref="ICommand.Execute" />
    /// method. Setting the <see cref="CommandParameter" /> will always result in that
    /// value will be sent. The <see cref="EventArgsParameterPath" /> will walk the
    /// property path on the instance of <see cref="EventArgs" /> for the event and, if
    /// any property found, pass that parameter. The <see cref="EventArgsConverter" />
    /// will call the <see cref="IValueConverter.Convert" /> method with the <see
    /// cref="EventArgsConverterParameter" /> and pass the result as parameter.
    /// </para>
    /// <para>
    /// The order of evaluation for the parameter to be sent to the <see
    /// cref="ICommand.Execute" /> method is
    /// 1. <see cref="CommandParameter" />
    /// 2. <see cref="EventArgsParameterPath" />
    /// 3. <see cref="EventArgsConverter" /> and as soon as a non- <c>null</c> value is
    /// found, the evaluation is stopped.
    /// </para>
    /// <example>
    /// &lt;ListView&gt; &lt;ListView.Behaviors&gt; &lt;behaviors:EventToCommandBehavior
    ...
    public class EventToCommandBehavior : BehaviorBase<BindableObject>
    {
        ...
        /// <summary>
        /// Bindable property to set Argument passed as parameter to <see
        /// cref="IValueConverter.Convert" />
        /// </summary>
        ...
        /// <summary>
        /// Bindable property to set instance of <see cref="IValueConverter" /> to convert
        /// the <see cref="EventArgs" /> for <see cref="EventName" />
        /// </summary>
        public static readonly BindableProperty EventArgsConverterProperty =
            BindableProperty.Create(nameof(EventArgsConverter), typeof(IValueConverter), typeof(EventToCommandBehavior));

        /// <summary>
        /// Bindable property to set Parameter path to extract property from <see
        /// cref="EventArgs" /> instance to pass to <see cref="ICommand.Execute" />
        /// </summary>
        ...
        /// <summary>
        /// Bindable property for Name of the event that will be forwarded to <see
        /// cref="EventToCommandBehavior.Command" />
        /// </summary>
        ...
        /// </summary>
        /// <para>
        /// If <see cref="EventArgsConverter" /> and <see
        /// cref="EventArgsConverterParameter" /> is set then the result of the conversion
        /// will be sent.
        /// </para>
        ...
        /// <summary>
        /// Instance of <see cref="IValueConverter" /> to convert the <see
        /// cref="EventArgs" /> for <see cref="EventName" />
        /// </summary>
        ...
        /// <summary>
        /// Parameter path to extract property from <see cref="EventArgs" /> instance to
        /// pass to <see cref="ICommand.Execute" />
        /// </summary>
        ...
        /// </summary>
        /// <remarks>
        /// An event that is invalid for the attached <see cref="View" /> will result in
        /// <see cref="ArgumentException" /> thrown.
        /// </remarks>
        ...
        /// </summary>
        /// <param name="bindable">
        /// Bindable object that is source of event to Attach
        /// </param>
        /// <exception cref="ArgumentException">
        /// Thrown if no matching event exists on <see cref="BindableObject" />
        /// </exception>
        ...
        /// </summary>
        /// <param name="bindable">
        /// <see cref="BindableObject" /> that is source of event
        /// </param>
